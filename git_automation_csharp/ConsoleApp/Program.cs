...
namespace gitA
{
    class Program
    {
        ...
        static readonly string  WORK = "2.21"; //1python 2c#, 앞자리는 major 웬만하면 뒷자리로..
        ...
        static int  ONE_ROUND_SIZE   = 18 * 60 + 30; //// 하루에 3개 올라오면 중간이라도 update 가능!
        static int  NEED_UPDATE_MAX  = 27;
        static int  RANDOM_STOP_MAX  = 39;
